...
<%@ page
	import="service.impl.*, services.*,beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="PANTRY"
								<%="PANTRY".equalsIgnoreCase(ptype) ? "selected" : ""%>>PANTRY</option>
							<option value="DINING ROOM"
								<%="DINING ROOM".equalsIgnoreCase(ptype) ? "selected" : ""%>>DINING ROOM</option>
							<option value="LIVING ROOM"
								<%="LIVING ROOM".equalsIgnoreCase(ptype) ? "selected" : ""%>>LIVING ROOM</option>
							<option value="BEDROOM"
								<%="BEDROOM".equalsIgnoreCase(ptype) ? "selected" : ""%>>BEDROOM</option>
							<option value="other"
